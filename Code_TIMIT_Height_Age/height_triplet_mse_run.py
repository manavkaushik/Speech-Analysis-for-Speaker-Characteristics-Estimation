...
if __name__ == '__main__':   
    ...
    csv_logger = CSVLogger('./', name='height_triplet_mse', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_height.Data_Module_height_tl(
    ...
    model = modules_height.lstm_crossattn_tl(
