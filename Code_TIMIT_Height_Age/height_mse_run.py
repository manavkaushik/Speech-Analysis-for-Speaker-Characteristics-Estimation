...
if __name__ == '__main__':   
    ...
    mse_male = MeanSquaredError().to(device)1
    ...
    csv_logger = CSVLogger('./', name='height_mse', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_height.Data_Module_height(
    ...
    model = modules_height.lstm_crossattn(
