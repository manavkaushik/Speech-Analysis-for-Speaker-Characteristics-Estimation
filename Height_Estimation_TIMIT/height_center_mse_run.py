...
if __name__ == '__main__':   
    ...
    params = dict(
        ...
        criterion_center = modules_height.CenterLoss(num_classes=13, feat_dim=864, use_gpu=True),     # Losses of BackProp
    ...
    csv_logger = CSVLogger('./', name='height_center_mse', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_height.Data_Module_height_center(
    ...
    model = modules_height.lstm_crossattn_center(
