...
def lstm_cross_att_multitask_model():
    ...
    model.compile(optimizer='adam', loss={'accent': 'categorical_crossentropy', 'gender': 'binary_crossentropy'}, metrics = {'accent': 'accuracy'}, 
