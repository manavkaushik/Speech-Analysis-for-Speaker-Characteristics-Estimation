...
def lstm_cross_att_model():
    ...
    mc = ModelCheckpoint('../../lstm_cross_att_model_wts.h5', monitor='val_loss', mode='min', save_best_only=True, save_weights = True, verbose=1)
    ...
    print()
    model.load_weights('../../lstm_cross_att_model_wts.h5')
