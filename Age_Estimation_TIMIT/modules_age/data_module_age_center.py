...
class Data_Module_age_center(pl.LightningDataModule):
    '''
    ...
    def train_dataloader(self):
        train_dataset = Train_Dataset_age_center()
    ...
    def val_dataloader(self):
        val_dataset = Val_Dataset_age_center()
    ...
    def test_dataloader(self):
        test_dataset = Test_Dataset_age_center()
