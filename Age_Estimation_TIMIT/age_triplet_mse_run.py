...
if __name__ == '__main__':   
    ...
    params = dict(
        ...
        criterion_tl = nn.TripletMarginLoss(),    # Losses of BackProp: Triplet Loss
    ...
    csv_logger = CSVLogger('./', name='age_triplet_mse', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_age.Data_Module_age_tl(
    ...
    model = modules_age.lstm_crossattn_tl(
                    n_features = params['n_features'],
                    hidden_size = params['hidden_size'],
                    seq_len = params['seq_len'],
                    batch_size = params['batch_size'],
                    criterion_age = params['criterion_age'], criterion_tl = params['criterion_tl'],
