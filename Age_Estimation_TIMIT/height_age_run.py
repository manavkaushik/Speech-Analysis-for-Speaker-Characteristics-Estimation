...
if __name__ == '__main__':   
    ...
    params = dict(
        ...
        criterion = nn.MSELoss(),       # Loss of BackProp (you may change it to 'nn.L1Loss' for MAE loss function)
        ...
        output_size = 1,                # Number of Outputs (1 for height/ age estimation)
    ...
    csv_logger = CSVLogger('./', name='height_age_mse_multitask', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_age.Data_Module_height_age(
    ...
    model = modules_age.lstm_crossattn_miltitask(
