...
if __name__ == '__main__':   
    ...
    params = dict(
        ...
        criterion = nn.MSELoss(),       # Loss of BackProp (you may change it to 'nn.L1Loss' for MAE as the loss function)  
    ...
    csv_logger = CSVLogger('./', name='age_mse', version='0') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = modules_age.Data_Module_age(
    ...
    model = modules_age.lstm_crossattn(
